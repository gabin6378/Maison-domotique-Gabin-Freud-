...
` + ne + "}",
    ...
    var nr, iX, jq, oX, zq, Kq, Yq, $q, Qq, Zq, Jq, eF, tF, rF, nF, fh, iF, oF, aF, vh = he(()=>{
        ...
        nr = le(Kt());
        Ge();
        ({HTML_ELEMENT: iX, PLAIN_OBJECT: jq, ABSTRACT_NODE: oX, CONFIG_X_VALUE: zq, CONFIG_Y_VALUE: Kq, CONFIG_Z_VALUE: Yq, CONFIG_VALUE: $q, CONFIG_X_UNIT: Qq, CONFIG_Y_UNIT: Zq, CONFIG_Z_UNIT: Jq, CONFIG_UNIT: eF} = Ce),
    ...
    var _h = c(ei=>{
        ...
        rt(Af))
          ...
          , FF = Ra(yh())
          , MF = Ra(Eh())
          , lX = ei.pluginMethodMap = new Map([[Ca.ActionTypeConsts.PLUGIN_LOTTIE, {
            ...qF
    ...
    function vM(e, t) {
        ...
        for (let i = 0; i < r.length; i++)
            if (!Object.hasOwn(t, r[i]) || !Bh(e[r[i]], t[r[i]]))
                return !1;
        return !0
    }
    var Va, Wh = he(()=>{
    ...
    function eD(e, t, r, n) {
        let i = (0,
        oi.default)(t, (a,s,u)=>`${a} ${u}(${s}${QM(u, r)})`, "")
          , {setStyle: o} = n;
        Dt(e, Xr, n),
        o(e, Xr, i)
    }
    ...
    var gt, oi, ri, ai, $h, gM, hM, yM, mM, EM, _M, bM, TM, IM, OM, ni, Xr, jr, ut, ct, Qh, wM, AM, Hh, xM, Xh, SM, ii, ir, At, zr, CM, Ua, Zh, Ba, Wa, Jh, or, ar, sr, Kr, ey, Yr, $r, ur, cr, lr, fr, si, RM, ty, Ha, ry, ti, NM, qM, DM, zh, VM, UM, WM, HM, XM, ja, YM, $M, QM, ZM, nD, iD, oD, oy, uy = he(()=>{
        ...
        Da();
        Qn();
        ({BACKGROUND: gM, TRANSFORM: hM, TRANSLATE_3D: yM, SCALE_3D: mM, ROTATE_X: EM, ROTATE_Y: _M, ROTATE_Z: bM, SKEW: TM, PRESERVE_3D: IM, FLEX: OM, OPACITY: ni, FILTER: Xr, FONT_VARIATION_SETTINGS: jr, WIDTH: ut, HEIGHT: ct, BACKGROUND_COLOR: Qh, BORDER_COLOR: wM, COLOR: AM, CHILDREN: Hh, IMMEDIATE_CHILDREN: xM, SIBLINGS: Xh, PARENT: SM, DISPLAY: ii, WILL_CHANGE: ir, AUTO: At, COMMA_DELIMITER: zr, COLON_DELIMITER: CM, BAR_DELIMITER: Ua, RENDER_TRANSFORM: Zh, RENDER_GENERAL: Ba, RENDER_STYLE: Wa, RENDER_PLUGIN: Jh} = Ce),
        {TRANSFORM_MOVE: or, TRANSFORM_SCALE: ar, TRANSFORM_ROTATE: sr, TRANSFORM_SKEW: Kr, STYLE_OPACITY: ey, STYLE_FILTER: Yr, STYLE_FONT_VARIATION: $r, STYLE_SIZE: ur, STYLE_BACKGROUND_COLOR: cr, STYLE_BORDER: lr, STYLE_TEXT_COLOR: fr, GENERAL_DISPLAY: si, OBJECT_VALUE: RM} = ke,
        ty = e=>e.trim(),
        Ha = Object.freeze({
            [cr]: Qh,
            [lr]: wM,
        ...
        DM = (e,t)=>e === t;
        zh = /px/,
        VM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = YM[n.type]),
        r), e || {}),
        UM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = $M[n.type] || n.defaultValue || 0),
        r), e || {});
        WM = (e,t)=>(t && (e[t.type] = t.value || 0),
        e),
    ...
    var ci, ht, AD, xD, SD, CD, RD, LD, ui, cy, ND, PD, za, qD, FD, MD, DD, ly, fy = he(()=>{
        ...
        ci = le(kt()),
        ht = le(Kt()),
        {IX2_RAW_DATA_IMPORTED: AD, IX2_SESSION_STOPPED: xD, IX2_INSTANCE_ADDED: SD, IX2_INSTANCE_STARTED: CD, IX2_INSTANCE_REMOVED: RD, IX2_ANIMATION_FRAME_CHANGED: LD} = Ie,
        {optimizeFloat: ui, applyEasing: cy, createBezierEasing: ND} = ci.IX2EasingUtils,
        {RENDER_GENERAL: PD} = Ce,
        {getItemConfigByKey: za, getRenderType: qD, getStyleProp: FD} = ci.IX2VanillaUtils,
        MD = (e,t)=>{
    ...
    var kD, GD, VD, dy, py = he(()=>{
        "use strict";
        Ge();
        ({IX2_RAW_DATA_IMPORTED: kD, IX2_SESSION_STOPPED: GD, IX2_PARAMETER_CHANGED: VD} = Ie),
        dy = (e={},t)=>{
            switch (t.type) {
            case kD:
    ...
    var lm = c((oj,cm)=>{
        ...
        function M2(e) {
            if (e == null)
                return !0;
            if (S2(e) && (x2(e) || typeof e == "string" || typeof e.splice == "function" || C2(e) || L2(e) || A2(e)))
                return !e.length;
            var t = w2(e);
            if (t == N2 || t == P2)
                return !e.size;
    ...
    var wm = c((dj,Om)=>{
        ...
        function ok(e, t, r) {
            ...
            return nk(r) && (n = "leading"in r ? !!r.leading : n,
    ...
    var Am, ak, sk, uk, ck, lk, fk, dk, pk, vk, gk, hk, yk, mk, Ek, _k, bk, Tk, Ik, Ok, wk, Ak, Ja, es, ts, rs, xk, Sk, Ck, Rk, li, Lk, ns, fi, pr, is, di, os, as, vr, ss, us, pi = he(()=>{
        ...
        Sk = ({actionTypeId: e=ke.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: a, verbose: s, rawData: u})=>({
            type: fk,
            payload: {
                actionTypeId: e,
                actionListId: t,
    ...
    var Cm, cs, Sm, Nk, Pk, Rm, Qr, Lm = he(()=>{
        ...
        {IX2_ID_DELIMITER: Sm, HTML_ELEMENT: Nk, PLAIN_OBJECT: Pk, WF_PAGE: Rm} = Ce;
    ...
    var TE = c((Fj,bE)=>{
        ...
        function qG(e) {
            ...
            return t.__actions__ = PG(e.__actions__),
    ...
    var xE = c((Dj,AE)=>{
        ...
        function jG(e) {
            var t = HG(e)
              , r = XG[t];
            if (typeof r != "function" || !(t in BG.prototype))
                return !1;
            if (e === r)
                return !0;
            var n = WG(r);
    ...
    var jE, zE, KE, YE, sV, uV, cV, lV, fV, dV, pV, vV, gV, hV, yV, mV, EV, _V, bV, $E, QE, TV, IV, OV, ZE, wV, AV, JE, xV, ms, e_, kE, GE, t_, Jr, SV, lt, r_, CV, Ue, et, en, n_, Es, VE, _s, RV, Zr, LV, NV, PV, i_, UE, qV, BE, FV, MV, DV, WE, _i, bi, HE, XE, o_, a_ = he(()=>{
        ...
        pi();
        YE = le(kt()),
        {MOUSE_CLICK: sV, MOUSE_SECOND_CLICK: uV, MOUSE_DOWN: cV, MOUSE_UP: lV, MOUSE_OVER: fV, MOUSE_OUT: dV, DROPDOWN_CLOSE: pV, DROPDOWN_OPEN: vV, SLIDER_ACTIVE: gV, SLIDER_INACTIVE: hV, TAB_ACTIVE: yV, TAB_INACTIVE: mV, NAVBAR_CLOSE: EV, NAVBAR_OPEN: _V, MOUSE_MOVE: bV, PAGE_SCROLL_DOWN: $E, SCROLL_INTO_VIEW: QE, SCROLL_OUT_OF_VIEW: TV, PAGE_SCROLL_UP: IV, SCROLLING_IN_VIEW: OV, PAGE_FINISH: ZE, ECOMMERCE_CART_CLOSE: wV, ECOMMERCE_CART_OPEN: AV, PAGE_START: JE, PAGE_SCROLL: xV} = Ze,
        ms = "COMPONENT_ACTIVE",
    ...
    function As(e) {
        let {store: t, computedStyle: r, ...n} = e, {element: i, actionItem: o, immediate: a, pluginInstance: s, continuous: u, restingValue: f, eventId: y} = n, g = !u, v = UV(), {ixElements: m, ixSession: w, ixData: I} = t.getState(), C = VV(m, i), {refState: O} = m[C] || {}, N = ds(i), R = w.reducedMotion && jo[o.actionTypeId], q;
        if (R && u)
    ...
    var c_, yt, l_, f_, d_, p_, hr, v_, Ti, kV, Ts, Is, Ii, g_, GV, s_, Oi, VV, Os, Gt, UV, BV, h_, WV, HV, XV, jV, zV, KV, wi, YV, $V, QV, ZV, JV, Ai, ws, eU, u_, tU, rU, hU, mU, EU, _U, bs = he(()=>{
        ...
        kV = Object.keys(On),
        Ts = e=>kV.includes(e),
        {COLON_DELIMITER: Is, BOUNDARY_SELECTOR: Ii, HTML_ELEMENT: g_, RENDER_GENERAL: GV, W_MOD_IX: s_} = Ce,
        {getAffectedElements: Oi, getElementId: VV, getDestinationValues: Os, observeStore: Gt, getInstanceId: UV, renderHTMLElement: BV, clearAllStyles: h_, getMaxDurationItemIndex: WV, getComputedStyle: HV, getInstanceOrigin: XV, reduceListToGroup: jV, shouldNamespaceEventParameter: zV, getNamespacedParameterId: KV, shouldAllowMediaQuery: wi, cleanupHTMLElement: YV, clearObjectCache: $V, stringifyTarget: QV, mediaQueriesEqual: ZV, shallowEqual: JV} = Ti.IX2VanillaUtils,
        {isPluginType: Ai, createPluginInstance: ws, getPluginDuration: eU} = Ti.IX2VanillaPlugins,
    ...
    var V_ = c((rz,G_)=>{
        ...
        xt.define("navbar", G_.exports = function(e, t) {
            var r = {}, n = e.tram, i = e(window), o = e(document), a = t.debounce, s, u, f, y, g = xt.env(), v = '<div class="w-nav-overlay" data-wf-ignore />', m = ".w-nav", w = "w--open", I = "w--nav-dropdown-open", C = "w--nav-dropdown-toggle-open", O = "w--nav-dropdown-list-open", N = "w--nav-link-open", R = PU.triggers, q = e();
    ...
    var W_ = c((nz,B_)=>{
        ...
        St.define("slider", B_.exports = function(e, t) {
            var r = {}, n = e.tram, i = e(document), o, a, s = St.env(), u = ".w-slider", f = '<div class="w-slider-dot" data-wf-ignore />', y = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', g = "w-slider-force-show", v = qU.triggers, m, w = !1;
            r.ready = function() {
                a = St.env("design"),
                I()
            }
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "664c5fa41ebc902708c49a34|e4b2f101-1163-76ec-342f-f42fd4d2974a",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".spark-team-member-card",
                "originalId": "664c5fa41ebc902708c49a34|ca47881b-ef60-6e4c-9a0b-064f579ea427",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".spark-team-member-card",
        ...
        "e-6": {
            ...
            "createdOn": 1718019555007
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Rounded Edge Navbar Open",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".spark-line-1.spark-simple-line",
                            "selectorGuids": ["e1139695-fa0a-6af5-089c-c650b8d68d7f", "e1139695-fa0a-6af5-089c-c650b8d68d8c"]
                        },
                        "yValue": 10,
                        "xUnit": "PX",
                        "yUnit": "px",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".spark-line-2.spark-simple-line",
                            "selectorGuids": ["e1139695-fa0a-6af5-089c-c650b8d68d7e", "e1139695-fa0a-6af5-089c-c650b8d68d8b"]
                        },
                        "xValue": 0,
                        "yValue": 0,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".spark-line-3.spark-simple-line",
                            "selectorGuids": ["e1139695-fa0a-6af5-089c-c650b8d68d7d", "e1139695-fa0a-6af5-089c-c650b8d68d8a"]
                        },
                        "yValue": -10,
                        "xUnit": "PX",
                        "yUnit": "px",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".spark-simple-menu-button",
                            "selectorGuids": ["e1139695-fa0a-6af5-089c-c650b8d68d80"]
                        },
                        "zValue": 90,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
        ...
        "a-2": {
            "id": "a-2",
            "title": "Rounded Edge Navbar Close",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_MOVE",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "selector": ".spark-container-3",
                            "selectorGuids": ["2e31f721-42b4-0f80-92c9-d31f061bbef5"]
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "6654b7e65cf815d2a2fe1653|66a6ca2b-1664-b78c-4c15-9d4099ab7afe"
                        },
                        "value": 1,
                        "unit": ""
                    }
